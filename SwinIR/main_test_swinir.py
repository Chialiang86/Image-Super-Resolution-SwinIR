...
def main():
    ...
    parser.add_argument('--inf_root', type=str, default='inference', help='inference root') 
    ...
    parser.add_argument('--model_path', type=str,
                        default='superresolution/swinir_sr_classical_patch48_x3/models/100000_G.pth')
    parser.add_argument('--folder_lq', type=str, default='../datasets/testing_lr_images', help='input low-quality test image folder')
    ...
    for idx, path in enumerate(sorted(glob.glob(os.path.join(folder, '*')))):
        ...
        cv2.imwrite(f'{save_dir}/{imgname}_pred.png', output) # modified
...
def setup(args):
    ...
    if args.task in ['classical_sr', 'lightweight_sr']:
        model_clear = os.path.splitext(os.path.basename(args.model_path))[0]
        save_dir = f'{args.inf_root}/{model_clear}_{args.training_patch_size}_{args.scale}'
