...
- There are two kinds of training data : 
    ...
    2. cropping image data in `dataset/hr_[imsize]` 
        - the cropping data can be generated by executing `python3 training_patch.py -r dataset -s training_hr_images -hr [imgsize]`
